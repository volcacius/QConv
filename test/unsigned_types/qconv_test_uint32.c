...
void qconv_test_lin_circ_convolution_uint32(size_t input_bit_size,
    ...
    qconv_zero_pad_uint32_1D_array(size, input_size, input, padded_input);
    qconv_zero_pad_uint32_1D_array(size, kernel_size, kernel, padded_kernel);
...
void qconv_test_zero_pad_uint32_1D_array() {
    ...
    qconv_zero_pad_uint32_1D_array(outer_size, inner_size, input, output);
...
void qconv_test_zero_pad_uint32_2D_array() {
    ...
    qconv_zero_pad_uint32_2D_array(outer_size_width, outer_size_height, inner_size_width, inner_size_height, input, output);
