...
enum qconv_status qconv_NTT_1D_circular_convolution_mod_crt_f_3_f_4(size_t size,
    ...
    #pragma omp parallel sections
    {
        #pragma omp section
        {
            qconv_NTT_1D_circular_convolution_uint32_mod_f_4(size, input, kernel, output, optimize_level);
        }
        #pragma omp section
        {
            qconv_NTT_1D_circular_convolution_uint16_mod_f_3(size, input_bis, kernel_bis, output_bis, optimize_level);
        }
    }
