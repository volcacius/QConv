...
const qconv_inner_uint16 qconv_const_f_4_DIT_r2_std2std_size_8_inverse[] =
        {1, 65281, 1, 65281, 1, 61441, 65281, 65521};

const qconv_inner_uint16 qconv_const_f_4_DIF_r2_std2rev_size_8_forward[] =
        {1, 16, 256, 4096, 1, 256, 1, 256};
const qconv_inner_uint16 *qconv_const_f_4_DIT_r2_rev2std_size_8_inverse =
...
const qconv_inner_uint16 qconv_const_f_4_DIT_r2_std2std_size_16_inverse[] =
        {1, 65281, 1, 65281, 1, 65281, 1, 65281, 1, 61441, 65281, 65521, 1, 61441, 65281, 65521, 1, 49153, 61441, 64513, 65281, 65473, 65521, 65533};
...
const qconv_inner_uint16 *qconv_const_f_4_DIT_r2_rev2std_size_16_inverse =
...
qconv_inner_uint16 *qconv_get_const_f_4_DIT_std2std_inverse(size_t size) {
    switch(size) {
        case QCONV_SIZE_8:
            return (qconv_inner_uint16 *) qconv_const_f_4_DIT_r2_std2std_size_8_inverse;
        case QCONV_SIZE_16:
            return (qconv_inner_uint16 *) qconv_const_f_4_DIT_r2_std2std_size_16_inverse;
    }
}
...
qconv_inner_uint16 *qconv_get_const_f_4_DIT_rev2std_inverse(size_t size) {
    switch(size) {
        case QCONV_SIZE_8:
            return (qconv_inner_uint16 *) qconv_const_f_4_DIT_r2_rev2std_size_8_inverse;
        case QCONV_SIZE_16:
            return (qconv_inner_uint16 *) qconv_const_f_4_DIT_r2_rev2std_size_16_inverse;
    }
}
